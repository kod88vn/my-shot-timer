...
import { Recording, RecordingStatus, Sound, RECORDING_OPTIONS_PRESET_HIGH_QUALITY } from 'expo-av/build/Audio';
  ...
  async function startRecording() {
    try {
      ...
      recording.setOnRecordingStatusUpdate((o)=> {
        ...
        o.metering && meters.length < 100 ? meters.push(o.metering) : meters.shift() && meters.push(o.metering)
